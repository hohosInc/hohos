...
from django_project.settings import ALLOWED_SIGNUP_DOMAINS
...
def InvalidUsernameValidator(value):
    if '@' in value or '+' in value or '-' in value or 'deepak' in value:
...
class SignUpForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['username', 'email','company' ,'password', 'confirm_password' ]
